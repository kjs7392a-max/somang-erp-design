...
UPDATE corporations SET company_notice_dept = '총무과' WHERE short_code = 'SM';
UPDATE corporations SET company_notice_dept = '기획실' WHERE short_code = 'HD';
...
INSERT INTO wards (corporation_id, code, sort_order) VALUES
  ('c1000000-0000-0000-0000-000000000001','1',1),
  ('c1000000-0000-0000-0000-000000000001','2',2),
  ('c1000000-0000-0000-0000-000000000001','3',3),
  ('c1000000-0000-0000-0000-000000000001','5',4),
  ('c1000000-0000-0000-0000-000000000001','8',5),
  ('c1000000-0000-0000-0000-000000000001','9',6),
  ('c1000000-0000-0000-0000-000000000001','10-A',7),
  ('c1000000-0000-0000-0000-000000000001','10-B',8),
  ('c1000000-0000-0000-0000-000000000001','11',9),
  ('c1000000-0000-0000-0000-000000000001','12',10),
...
INSERT INTO notice_departments (corporation_id, department) VALUES
  ('c1000000-0000-0000-0000-000000000001','총무과'),
  ('c1000000-0000-0000-0000-000000000001','원무과'),
  ('c1000000-0000-0000-0000-000000000001','사회복지과'),
  ('c1000000-0000-0000-0000-000000000001','약국'),
  ('c1000000-0000-0000-0000-000000000001','영양과'),
  ('c1000000-0000-0000-0000-000000000001','간호과'),
...
INSERT INTO announcements (corporation_id, scope, title, body, author_name, author_dept, pinned, published_at) VALUES
  ('c1000000-0000-0000-0000-000000000001','company','2026년 4월 20일 통합 워크숍 안내','전 직원 대상 통합 워크숍을 4월 20일(월) 오전 9시부터 본관 대강당에서 실시합니다. 참석 대상은 별도 공지를 확인해주세요.','김행정 팀장','인사팀',true,'2026-04-15'),
  ...
  ('c1000000-0000-0000-0000-000000000001','company','사내 메신저 시스템 점검 안내','4월 22일(수) 02:00~04:00 동안 메신저 서버 점검이 있습니다. 해당 시간 로그인이 제한됩니다.','박시스 과장','정보전산팀',false,'2026-04-14'),
...
INSERT INTO announcements (corporation_id, scope, target_dept, title, body, author_name, author_dept, pinned, published_at) VALUES
  ('c1000000-0000-0000-0000-000000000001','dept','총무과','5월 비품 신청 마감 안내','5월 비품 신청 마감일은 4월 25일(금)입니다. 각 부서 비품 신청서를 기한 내 총무과로 제출해 주시기 바랍니다.','한기석 총무과장','총무과',true,'2026-04-16'),
  ('c1000000-0000-0000-0000-000000000001','dept','총무과','총무과 내부 회의 일정 변경','4월 23일(수) 예정이던 총무과 주간회의가 4월 24일(목) 오전 10시로 변경되었습니다. 참고하시기 바랍니다.','한기석 총무과장','총무과',false,'2026-04-15');

-- 부서공지: SM 간호과 (병동 명단 적재 전이라 간호과 전체 대상으로 임시 seed)
INSERT INTO announcements (corporation_id, scope, target_dept, title, body, author_name, author_dept, pinned, published_at) VALUES
  ('c1000000-0000-0000-0000-000000000001','dept','간호과','5월 근무표 배포 안내','5월 근무표가 확정되어 배포되었습니다. 변경사항 확인 후 이상 있으면 수간호사에게 문의 바랍니다.','이수간 수간호사','간호과',true,'2026-04-15'),
  ('c1000000-0000-0000-0000-000000000001','dept','간호과','간호과 감염관리 교육 일정','4월 28일(화) 13:00 감염관리 교육을 진행합니다. 전원 참석 바랍니다.','정감염 감염관리전담','간호과',false,'2026-04-12');
