...
type QuickDraft = {
  key: string;
  formKind: FormKind | null; // null = 미구현 (경비/구매/의료 등)
  label: string;
  Icon: typeof Plane;
  bg: string;
  tint: string;
...
const QUICK_DRAFTS: QuickDraft[] = [
  { key: "vacation", formKind: "vacation",    label: "연차 신청서",   Icon: Plane,        bg: "#e8f4ff", tint: "#3b5bdb" },
  { key: "proposal", formKind: "proposal",    label: "품의서",        Icon: FileText,     bg: "#f1f3f5", tint: "#495057" },
  { key: "resign",   formKind: "resignation", label: "사직원",        Icon: FileText,     bg: "#fff5f5", tint: "#c92a2a" },
  { key: "overtime", formKind: null,          label: "초과근무 신청", Icon: Clock,        bg: "#fff4e6", tint: "#f08c00" },
  { key: "expense",  formKind: null,          label: "경비 청구",     Icon: Receipt,      bg: "#e6fcf5", tint: "#0ca678" },
  { key: "purchase", formKind: null,          label: "물품 구매 요청", Icon: ShoppingCart, bg: "#fff0f6", tint: "#d6336c" },
  ...
  return (
    <div className="px-5 py-5">
      ...
      <section className="mb-6">
        <h2 className="mb-3 text-[1.0625rem] font-bold text-zinc-900">자주 쓰는 기안</h2>
